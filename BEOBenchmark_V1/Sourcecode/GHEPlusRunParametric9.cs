...
{
    public class GHEPlusRunParametric9 : GH_Component
    {
        /// <summary>
        /// Initializes a new instance of the GHEPlusRunParametric9 class.
        /// </summary>
        public GHEPlusRunParametric9()
            : base("Prob9Kämpf", "Prob9Kämpf",
                "Problem 9 Kämpf & Wetter 2010, small office, with single zoned AC and gas furnace.",
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            if (runit == true)
            {
                ...
                replacers[13] = (x[8] * 0.0006875 - 0.00025).ToString();
        ...
        protected override System.Drawing.Bitmap Icon
        {
            get
            {
                ...
                return GHEnergyPlus.Properties.Resources.opti_9;
            }
        }
        ...
        {
            get { return new Guid("{0fab5b41-8e36-4685-b0c5-f43669757ec5}"); }
        }
    }
}